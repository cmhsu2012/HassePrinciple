...
%By Corollary \textcolor{red}{TODO} when $v=p$, and Lemma \textcolor{red}{TODO} when $v= \infty$, this is equivalent to saying that 
By Lemma \textcolor{red}{TODO}, this is equivalent to saying that 
\[ (x_v, -ab)_v = (a, b)_v \quad \text{and} \quad (x_v, -cd)_v = (c, d)_v \: \text{ for all } v \in V. \]

Since $\displaystyle \prod_{v \in V} (a, b)_v = \prod_{v \in V} (c, d)_v = 1$ by Theorem \ref{thm:product_formula}, we can deduce from \textcolor{red}{TODO} the existence of $x \in \Q^\times$ such that 
