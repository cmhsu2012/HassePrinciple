...
\uses{def:everywhere_locally_isotropic, lem:equiv_sum_squares, cor:prod_isotropic_iff, thm:product_formula, lem:represents_iff,
...
\uses{def:everywhere_locally_isotropic, lem:equiv_sum_squares, thm:padic_squares_open, thm:approximation, def:HM_inv, lem:isotr_of_rk_four, lem:represents_iff}
\leanok
